 ...
 * @author matt
 */
public class winPlayersPanel extends JPanel {

    public winPlayersPanel() {
    ...
    public void createView(CreateViewEvent ev) {
        ...
        if(currentScore != null){
            this.removeAll();
            this.setLayout(new GridLayout(currentScore.getWinSortedPlayers().size(), 1));
            Collection<ScorePlayer> winPlayers = currentScore.getWinSortedPlayers();
            int i = 1;
            for (ScorePlayer currentScorePlayer : winPlayers) {
